...
\firstreviewerinfo{Department of Analytic Computing}

\secondreviewer{Max Mustermann}
\secondreviewerinfo{Department of Analytic Computing}
...
% Please select the choices in the declaration for each item individually (Y = Yes; N= No)
\declarationchoices{N}{N}{N}{N}{N}
%\declarationchoices{Y}{Y}{Y}{Y}{Y}
